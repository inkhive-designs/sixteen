<?php
/*
 * @package sixteen, Copyright Rohit Tripathi, rohitink.com
...
require get_template_directory() . '/framework/admin_modules/custom_scripts.php';
require get_template_directory() . '/framework/admin_modules/custom_head_codes.php';
